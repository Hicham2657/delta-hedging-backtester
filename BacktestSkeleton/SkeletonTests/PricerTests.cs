...
namespace SkeletonTests
{
    public class PricerTests
    {
        ...
        [Test]
        public void Price_ReturnsDeltaBetweenZeroAndOne()
        {
            var results = _pricer.Price(new DateTime(2023, 6, 22), [10]);
        ...
        [Test]
        public void Price_IncreasesWithSpot()
        {
            var lowSpotResult = _pricer.Price(new DateTime(2023, 6, 22), [9]);
            var highSpotResult = _pricer.Price(new DateTime(2023, 6, 22), [10]);
            Assert.That(highSpotResult.Price, Is.GreaterThan(lowSpotResult.Price));
        }
    }
}